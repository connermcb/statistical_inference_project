...
The dataset contains the length of odontoblasts (cells responsible for tooth growth) in 60 guinea pigs. Each animal received one of three dosages of vitamin C (0.5, 1, 2 mg/day) by one of two delivery methods, orange juice or ascorbic acid. The animals were evenly distributed across the six groups created by the intersection of the variables `supplement` and `dose`. `r table(ToothGrowth$dose, ToothGrowth$supp)`
...
legend(23, 8, c("Orange Juice", "Ascorbic Acid"), fill="red", "blue")
